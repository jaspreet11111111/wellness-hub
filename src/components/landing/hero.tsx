            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="inline-block px-6 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full mb-6">
                        <span className="text-white/90 font-medium">🌞 Sun Worshipper | Halifax, NS</span>
                    </div>
                    ...
                    <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto drop-shadow">
                        Yoga Teacher | Thai Massage Practitioner | Early Childhood Educator.
                        Join me for mindful movement, deep relaxation, and authentic connection in beautiful Halifax, Nova Scotia.
                    </p>
                    ...
                    <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mt-16">
                        <div className="text-center">
                            <div className="text-4xl font-bold text-white mb-1">750+</div>
                            <div className="text-white/70 text-sm">Instagram Community</div>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="text-center">
                            <div className="text-4xl font-bold text-white mb-1">128+</div>
                            <div className="text-white/70 text-sm">Shared Moments</div>
                        </div>
                    </div>
                </div>
            </div>
